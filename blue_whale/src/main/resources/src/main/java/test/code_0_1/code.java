...
/**
 * Job: code Purpose: regarder le code pour comprendre comment connecter le fichier excel<br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class code implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "code";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(code.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class lienStruct implements routines.system.IPersistableRow<lienStruct> {
    final static byte[] commonByteArrayLock_TEST_code = new byte[0];
    static byte[] commonByteArray_TEST_code = new byte[0];

	
			    public String Exporter_ISO3;

				public String getExporter_ISO3 () {
					return this.Exporter_ISO3;
				}
			    ...
			    public String Importer_ISO3;

				public String getImporter_ISO3 () {
					return this.Importer_ISO3;
				}
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_TEST_code.length) {
				if(length < 1024 && commonByteArray_TEST_code.length == 0) {
   					commonByteArray_TEST_code = new byte[1024];
				} else {
   					commonByteArray_TEST_code = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_TEST_code, 0, length);
			strReturn = new String(commonByteArray_TEST_code, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_TEST_code) {

        	try {

        		int length = 0;
		
					this.Exporter_ISO3 = readString(dis);
					
					this.Exporter = readString(dis);
					
					this.Importer_ISO3 = readString(dis);
					
					this.Importer = readString(dis);
					
					this.Resource = readString(dis);
					
						this.years = readInteger(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.Exporter_ISO3,dos);
					
					// String
				
						writeString(this.Exporter,dos);
					
					// String
				
						writeString(this.Importer_ISO3,dos);
					
					// String
				
						writeString(this.Importer,dos);
					
					// String
				
						writeString(this.Resource,dos);
					
					// Integer
				
						writeInteger(this.years,dos);
    ...
    public String toString() {
		...
		sb.append("[");
		sb.append("Exporter_ISO3="+Exporter_ISO3);
		sb.append(",Exporter="+Exporter);
		sb.append(",Importer_ISO3="+Importer_ISO3);
		sb.append(",Importer="+Importer);
     ...
     * Compare keys
     */
    public int compareTo(lienStruct other) {
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    ...
    static byte[] commonByteArray_TEST_code = new byte[0];
			    ...
			    public Integer Exporter_M_49;

				public Integer getExporter_M_49 () {
					return this.Exporter_M_49;
				}
			    ...
			    public String Exporter_region;

				public String getExporter_region () {
					return this.Exporter_region;
				}
				
			    public Integer Importer_M_49;

				public Integer getImporter_M_49 () {
					return this.Importer_M_49;
				}
			    ...
			    public String Importer_region;

				public String getImporter_region () {
					return this.Importer_region;
				}
			    ...
			    public Integer HS_1996;

				public Integer getHS_1996 () {
					return this.HS_1996;
				}
			    ...
			    public Float Value__1000USD_;

				public Float getValue__1000USD_ () {
					return this.Value__1000USD_;
				}
				
			    public Float Weight__1000kg_;

				public Float getWeight__1000kg_ () {
					return this.Weight__1000kg_;
				}
		...
		synchronized(commonByteArrayLock_TEST_code) {
        	...
        	try {
        		...
        		int length = 0;
						...
						this.Exporter_M_49 = readInteger(dis);
					
					this.Exporter_ISO3 = readString(dis);
					
					this.Exporter = readString(dis);
					
					this.Exporter_region = readString(dis);
					
						this.Importer_M_49 = readInteger(dis);
					
					this.Importer_ISO3 = readString(dis);
					
					this.Importer = readString(dis);
					
					this.Importer_region = readString(dis);
					
					this.Resource = readString(dis);
					
						this.HS_1996 = readInteger(dis);
					
						this.Year = readInteger(dis);
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.Value__1000USD_ = null;
           				} else {
           			    	this.Value__1000USD_ = dis.readFloat();
           				}
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.Weight__1000kg_ = null;
           				} else {
           			    	this.Weight__1000kg_ = dis.readFloat();
           				}
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// Integer
						...
						writeInteger(this.Exporter_M_49,dos);
					...
					// String
						...
						writeString(this.Exporter_region,dos);
					
					// Integer
				
						writeInteger(this.Importer_M_49,dos);
					...
					// String
						...
						writeString(this.Importer_region,dos);
					...
					// Float
						...
						if(this.Value__1000USD_ == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeFloat(this.Value__1000USD_);
		            	}
					
					// Float
				
						if(this.Weight__1000kg_ == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeFloat(this.Weight__1000kg_);
		            	}
    ...
    public String toString() {
		...
		sb.append(super.toString());
		sb.append("[");
		sb.append("Exporter_M_49="+String.valueOf(Exporter_M_49));
		sb.append(",Exporter_ISO3="+Exporter_ISO3);
		sb.append(",Exporter="+Exporter);
		sb.append(",Exporter_region="+Exporter_region);
		sb.append(",Importer_M_49="+String.valueOf(Importer_M_49));
		sb.append(",Importer_ISO3="+Importer_ISO3);
		sb.append(",Importer="+Importer);
		sb.append(",Importer_region="+Importer_region);
		sb.append(",Resource="+Resource);
		sb.append(",HS_1996="+String.valueOf(HS_1996));
		sb.append(",Year="+String.valueOf(Year));
		sb.append(",Value__1000USD_="+String.valueOf(Value__1000USD_));
		sb.append(",Weight__1000kg_="+String.valueOf(Weight__1000kg_));
		sb.append(",source="+source);
	    sb.append("]");
...
lienStruct lien = new lienStruct();
	...
	currentComponent="tFileOutputExcel_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"lien");
					}
		...
		String fileName_tFileOutputExcel_1="C:/talend/TOS_DI-Win32-20200219_1130-V7.3.1/workspace/out.xls";
...
lienStruct lien_tmp = new lienStruct();
// ###############################
 ...
 */
	...
	final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:0WGiEojvGURM8HRPde98PdbxFmDhkPU1M/K8HQ==");
		...
		Object source_tFileInputExcel_1 = "C:/Users/DELL/Desktop/App_blue_whale/blue_whale/uploads/resourcetradeearth-plum-2019 (1).xlsx\\\";
        ...
        sheetList_tFileInputExcel_1.addAll(regexUtil_tFileInputExcel_1.getSheets(workbook_tFileInputExcel_1, "Trades", false));
	...
	if(sheetList_tFileInputExcel_1.size()>0){
        ...
        for(int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++){
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				curColName_tFileInputExcel_1 = "Exporter_M_49";

				row1.Exporter_M_49 = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
				row1.Exporter_M_49 = null;
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "Exporter_ISO3";

				row1.Exporter_ISO3 = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row1.Exporter_ISO3 = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "Exporter";

				row1.Exporter = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row1.Exporter = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "Exporter_region";

				row1.Exporter_region = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row1.Exporter_region = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "Importer_M_49";

				row1.Importer_M_49 = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
				row1.Importer_M_49 = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "Importer_ISO3";

				row1.Importer_ISO3 = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row1.Importer_ISO3 = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "Importer";

				row1.Importer = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row1.Importer = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "Importer_region";

				row1.Importer_region = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row1.Importer_region = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "Resource";

				row1.Resource = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row1.Resource = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "HS_1996";

				row1.HS_1996 = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
				row1.HS_1996 = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row1.Year = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
				row1.Year = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "Value__1000USD_";

				row1.Value__1000USD_ = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
				row1.Value__1000USD_ = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "Weight__1000kg_";

				row1.Weight__1000kg_ = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
				row1.Weight__1000kg_ = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "source";

				row1.source = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row1.source = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
...
// # Output table : 'lien'
lien_tmp.Exporter_ISO3 = row1.Exporter_ISO3 ;
lien_tmp.Exporter = row1.Exporter ;
lien_tmp.Importer_ISO3 = row1.Importer_ISO3 ;
lien_tmp.Importer = row1.Importer ;
lien_tmp.Resource = row1.Resource ;
lien_tmp.years = row1.Year ;
lien_tmp.Value = row1.Value__1000USD_ ;
lien_tmp.Weight = row1.Weight__1000kg_ ;
lien_tmp.source = "resource trade earth";
lien = lien_tmp;
// ###############################
...
if(lien != null) { 
	...
	currentComponent="tFileOutputExcel_1";
					...
					if(execStat){
						runStat.updateStatOnConnection(iterateId,1,1,"lien");
					}
					

								   				
	    				if(lien.Exporter_ISO3 != null) {
 ...
 */
	...
	currentComponent="tFileOutputExcel_1";
		...
		globalMap.put("tFileOutputExcel_1_NB_LINE",nb_line_tFileOutputExcel_1);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"lien");
			  	}
 ...
 */
    ...
    public static void main(String[] args){
        final code codeClass = new code();

        int exitCode = codeClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = code.class.getClassLoader().getResourceAsStream("test/code_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = code.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : code");
        }
...
/************************************************************************************************
 *     74023 characters generated by Talend Open Studio for Data Integration 
 *     on the 11 juillet 2021 15:18:11 CEST
 ************************************************************************************************/