...
import com.BDD.blue_whale.config.JwtUtils;
import com.BDD.blue_whale.config.UserDetailsImpl;
...
public class AuthController {
	...
	public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
		...
		User user = new User(null, signUpRequest.getFirst_name(),signUpRequest.getLast_name(), 
				 encoder.encode(signUpRequest.getPasswords()), 
				 signUpRequest.getEmail(),
				 null, signUpRequest.getDepartment(), null);
